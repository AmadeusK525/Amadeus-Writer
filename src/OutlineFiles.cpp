...
void amdOutlineFilesPanel::Init() {
	wxVector<Character>& charList = amdGetManager()->GetCharacters(0);
	wxVector<Location>& locList = amdGetManager()->GetLocations(0);
	wxVector<Item>& itemList = amdGetManager()->GetItems(0);
