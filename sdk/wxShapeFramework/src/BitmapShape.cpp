...
wxSFBitmapShape::wxSFBitmapShape(const wxRealPoint& pos, const wxString& bitmapPath, wxSFDiagramManager* manager, wxBitmapType type)
: wxSFRectShape(pos, wxRealPoint(1, 1), manager)
{
	...
	CreateFromFile(bitmapPath, type);
