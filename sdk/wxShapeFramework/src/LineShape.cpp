...
void wxSFLineShape::SetSrcArrow(wxSFArrowBase* arrowShape)
{
	if(m_pSrcArrow)delete m_pSrcArrow;

	m_pSrcArrow = arrowShape;
	if(m_pSrcArrow)
	{
...
void wxSFLineShape::SetTrgArrow(wxSFArrowBase* arrowShape)
{
	if(m_pTrgArrow)delete m_pTrgArrow;

	m_pTrgArrow = arrowShape;
	if(m_pTrgArrow)
	{
